...
class Home extends CI_Controller {
	...
	{
	    $data['tajuk'] = 'Kasir - Tables';
		$id_user = $this->session->userdata('id');
		$data['getProfile'] = $this->mod_sb->mengambil('tb_user', ['id'=>$id_user])->num_rows();
...
/* Location: ./application/controllers/Kasir/Home.php */